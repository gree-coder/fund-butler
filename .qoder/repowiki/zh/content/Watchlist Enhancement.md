...
## 更新摘要
**所做更改**
- 新增按基金代码移除功能，支持通过基金代码直接删除自选记录
- 改进API接口设计，提供更灵活的删除方式
- 增强数据处理能力，优化重复基金检测和去重逻辑
- 完善CLI命令行工具的删除功能
- 优化前端交互体验，支持多种删除方式
...
**重大更新**：自选股页面进行了全面重设计，增强了用户界面和交互功能，新增了智能估价系统和权重可视化展示，同时新增了按基金代码移除功能，提供更灵活的管理方式。
...
3. **批量查询**：优化多基金数据的批量获取
4. ****新增**：优化按基金代码删除的查询性能，确保fund_code字段有索引**
