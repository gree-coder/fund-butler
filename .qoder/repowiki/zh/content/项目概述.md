...
- 新增完整的数据库设计和实体关系说明
- 添加PRD产品需求文档的架构映射
- **新增**：移除Chrome DevTools技能相关文档引用，反映功能移除
...
- [EastMoneyDataSource.java:91-113](file://src/main/java/com/qoder/fund/datasource/EastMoneyDataSource.java#L91-L113)
...
**图表来源**
- [FundController.java:22-66](file://src/main/java/com/qoder/fund/controller/FundController.java#L22-L66)
...
- [FundDataSyncScheduler.java:39-667](file://src/main/java/com/qoder/fund/scheduler/FundDataSyncScheduler.java#L39-L667)
...
- [EastMoneyDataSource.java:48-88](file://src/main/java/com/qoder/fund/datasource/EastMoneyDataSource.java#L48-L88)
...
**章节来源**
- [pom.xml:20-93](file://pom.xml#L20-L93)
- [package.json:12-39](file://fund-web/package.json#L12-L39)
...
**更新说明**：根据代码库分析，项目中已移除Chrome DevTools相关技能配置。在skills-lock.json文件中不再包含"chrome-devtools"技能条目，这反映了项目功能的精简和去复杂化。项目现已专注于核心的基金管理和数据聚合功能，移除了不必要的开发工具集成，使整体架构更加简洁高效。
