...
## 更新摘要
**变更内容**
- 前端ESLint配置从传统配置系统迁移到ESLint 9+的flat配置格式
- 新增eslint.config.js文件，移除.eslintrc.cjs配置文件
- 更新package.json中的lint脚本，提供更好的性能、插件集成和开发者体验
...
**图表来源**
- [pom.xml:1-169](file://pom.xml#L1-L169)
