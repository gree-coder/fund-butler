...
**图表来源**
- [index.tsx:12-160](file://fund-web/src/pages/Dashboard/index.tsx#L12-L160)
...
subgraph "数据访问层"
L[FundDataAggregator]
M[EastMoneyDataSource]
N[StockEstimateDataSource]
O[FundMapper]
P[FundNavMapper]
end
subgraph "数据存储"
...
ChartComponent --> ECharts : "渲染"
```

**图表来源**
- [index.tsx:12-160](file://fund-web/src/pages/Dashboard/index.tsx#L12-L160)
- [PriceChange.tsx:4-18](file://fund-web/src/components/PriceChange.tsx#L4-L18)

**章节来源**
- [EastMoneyDataSource.java:24-696](file://src/main/java/com/qoder/fund/datasource/EastMoneyDataSource.java#L24-L696)
- [StockEstimateDataSource.java:22-184](file://src/main/java/com/qoder/fund/datasource/StockEstimateDataSource.java#L22-L184)
- [index.tsx:12-160](file://fund-web/src/pages/Dashboard/index.tsx#L12-L160)
- [PriceChange.tsx:1-18](file://fund-web/src/components/PriceChange.tsx#L1-L18)
...
该系统为个人投资者提供了一个强大而易用的基金数据管理平台，通过实时数据可视化和智能分析功能，帮助用户做出更明智的投资决策。