...
- **增强EastMoneyDataSource日期解析能力：支持新的HTML格式中日期出现在font标签内的解析，以及传统中文日期格式和数字季度表示的支持**
...
**图表来源**
- [EastMoneyDataSource.java:395-407](file://src/main/java/com/qoder/fund/datasource/EastMoneyDataSource.java#L395-L407)
...
- [EastMoneyDataSource.java:524-1002](file://src/main/java/com/qoder/fund/datasource/EastMoneyDataSource.java#L524-L1002)
...
**更新** 本次更新重点反映了系统的重要增强，包括新增的估算分析功能、补偿日志记录系统、历史数据处理改进等重大升级，以及新增的核心组件如EstimateAnalysisService、EstimateAnalysisDTO、EstimateAnalysisTab等。特别重要的是EastMoneyDataSource的日期解析能力增强，支持新的HTML格式中日期出现在font标签内的解析，以及传统中文日期格式和数字季度表示的支持，这些增强显著提升了系统的数据分析能力和用户体验。